...
## [Unreleased]
- Изменен рабочий сервер на idim772.ru
- Добавлен новый алгоритм поиска максимумов
- Изменен перечень данных, отправляемях на сервер
- Увеличен период запросов прошивки
- Увеличено время ожидания при загрузке модема
- Добавлена защита на случай, если данные АЦП не успели обработаться, а уже появились новые
